...
swiftc -O -target arm64-apple-macosx14.0 \
  ...
  "$ROOT/Sources/Log.swift" "$ROOT/Sources/Scanner.swift" "$ROOT/Sources/PanelUI.swift" "$ROOT/Sources/main.swift" \
  -framework Cocoa -framework SwiftUI -framework Carbon
